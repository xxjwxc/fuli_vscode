  ...
  if (info != null) {
    ...
    if (info.isVip) {
      ...
      ElMessageBox.confirm(
        ...
        .then(() => {
          location.href = 'https://www.xxjwxc.cn/webshares/#/pages/vip/level?platform=vscode'
        })
    }
  }
}
...
const setUrl = async (code) => {
  ...
  if (info) {
    data.info = info.info;
    data.iframeUrl = "https://www.xxjwxc.cn" + data.info.img.replace("/echarts/echarts.html", "/echarts1/echarts.html");
  }
