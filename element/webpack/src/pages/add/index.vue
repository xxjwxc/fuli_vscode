    ...
    async loadData(options) {
      ...
      if (this.code != null && this.code.length > 0) {
        ...
        let info = await Shares.Search(this.searchValue, this.tag); // 获取所有的中文代码
				if (info) {
					this.info = info.info;
          this.iframeUrl = "https://www.xxjwxc.cn" + this.info.img.replace("/echarts/echarts.html", "/echarts1/echarts.html");
          this.iframeUrl2 = "https://www.xxjwxc.cn/webshares/#/pages/add/add?platform=vscode&scode=" + this.searchValue + addtag;
